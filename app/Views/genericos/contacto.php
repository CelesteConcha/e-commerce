...
<div id="contact" class="container-fluid bg-black letraContaco" >
  ...
  <div class="row">
    <div class="col-sm-5"">
    <p style="font-size:medium;"><span><img src="<?php  echo base_url()?>/imagenes/icons/ub.jpeg" style="width: 40px; padding-right:10px;"></span>Merida Yucatan</p>
      <p style="font-size:medium;"><span><img src="<?php  echo base_url()?>/imagenes/icons/tel.jpeg" style="width: 40px; padding-right:10px;" ></span>99-93-35-43-42</p>
      <p style="font-size:medium;"><span><img src="<?php  echo base_url()?>/imagenes/icons/gm.jpeg" style="width: 40px; padding-right:10px;"></span> contacto@worldgames.com.mx</p>
    </div>
